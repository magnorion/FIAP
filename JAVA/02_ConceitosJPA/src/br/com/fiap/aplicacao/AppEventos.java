...
public class AppEventos {
	...
	private static void incluirEvento() {
		...
		evento.setDescricao("Um evento legal");
		evento.setResponsavel("Tester");
		evento.setData(new Date());
		
		Participante t1 = new Participante();
		t1.setEmail("teste@te4ste.com");
		t1.setEvento(evento);
		t1.setNome("John Teste");
		
		evento.getParticipantes().add(t1);
